...
!! MODIFIED
! PRESSURE
! Define two variables. pressure_total is the sum of the instantaneous pressure; pressure_cumulative_total is the summed-over-time total pressure	
    REAL :: pressure_total, pressure_cumulative_total
! Two arrays (instantaneous and summed-over-time) of n_atom length
    REAL(8), ALLOCATABLE :: pressure_i(:), pressure_cumulative_i(:)
    LOGICAL :: output_pres
