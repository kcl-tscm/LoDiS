...
NAMELIST/simul/irand,tstep,npas,scrivo,npast,tinit,&
              &type_process,output_xyz, output_pres, mgo_substrate,geometry_type,metal_on_top,&
...
eta_b = 0.d0
output_xyz = .true.
output_pres = .false. !Output the pressure on xyz movie files
!
!SYSTEM
natom= 0
type_potential='rgl'
...
ELSE
   ...
   IF(type_process == 'canon' ) canonical = 'ya'
