...
!! MODIFIED
! PRESSURE
! We allocate here the two arrays, 1d, one element per atom. 
! pressure_i is the instantaneous pressure; pressure_cumulative_i is the summed-over-time-steps pressure
  ALLOCATE(pressure_i(natom), pressure_cumulative_i(natom))
